...
def main():
    ...
    parser.add_argument('--dataset_path', type=str, default='/media/ricardo/OS/TCM/dataset/few_nerd/0.9',
           help='checkpoint name.')
    ...
    print('loading data...')
    opt.train = f'{opt.dataset_path}/train.txt'
    opt.test = f'{opt.dataset_path}/test.txt'
